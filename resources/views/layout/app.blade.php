...
<html class="no-js" lang="zxx">
    <head>
        ...
        <title>Trang tin tức🆕 Vũng Tàu Page</title>
                            ...
                            <div class="row d-flex justify-content-between align-items-center">
                                <div class="header-info-left">
                                    <ul>     
                                        ...
                                        <li><img src="assets/img/icon/header_icon1.png" alt=""><script>document.write(new Date().toLocaleString());</script></li>
                                    </ul>
                                </div>
                        ...
                        <div class="single-footer-caption">
                            <div class="single-footer-caption">
                                ...
                                <div class="footer-logo">
                                    ...
                                    <a href="{{ route('tin.index') }}"><h3 class="text-warning">📰-VT-⚓</h3></a>
                                </div>
