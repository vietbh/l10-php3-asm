        ...
        <div class="container">
            <div class="trending-main">
                ...
                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="single-bottom mb-35">
                                            <div class="trend-bottom-img mb-30">
                                                <img src="{{$item->images}}" width="200" height="200" alt="">
                                            </div>
                                            <div class="trend-bottom-cap">
                                                <span class="color1">{{$item->tags}}</span>
                                                <h4><a class="a-title"  href="{{ route('tin.single',['id' => $item->id]) }}">{{ $item->title }}</a></h4>
                                            </div>
                                        </div>
                                                    {{-- <p>{{ $item->content }}</p>
                    ...
                    <!-- Riht content -->
                    <div class="col-lg-4">
                        @foreach ($tins_right as $v)
                            <div class="trand-right-single d-flex">
                                <div class="trand-right-img">
                                    <img  src="{{$v->images}}" width="100" height="100" alt="">
                                </div>
                                <div class="trand-right-cap">
                                    <span class="color3">{{$v->views}}👀</span>
                                    <h4><a href="{{route('tin.single',['id' => $v->id])}}">{{$v->title}}</a></h4>
                                </div>
                            </div>
                        ...
                        <div class="properties__button">
                            ...
                            <nav>                                                                     
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    ...
                                    @foreach ($tinTL_en as $v)
                                        <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">{{$v->category_nm}}</a>
                                    @endforeach
